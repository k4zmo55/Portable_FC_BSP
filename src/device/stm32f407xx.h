 ...
 * stm32f407xx.h
 *
 * STM32F407xx varyantina ozel tanimlar: IRQn_Type (NVIC kesme numaralari)
 * ve bu varyanta ozgu Ethernet MAC ile RNG periferiklerinin taban
 * adresleri. Ortak register haritalari ve PCLK makrolari icin bkz. stm32f4xx.h.
 */
#ifndef FC_STM32F407XX_H
#define FC_STM32F407XX_H
...
/******************************************************
        ...
        STM32F407xx'e ozel periferik taban adresleri
        (Ethernet MAC -- AHB1 uzerinde, RNG -- AHB2 uzerinde)

        NOT: Bu periferiklerin register haritasi (RegDef_t)
        henuz tanimlanmadi; ilgili surucu yazilirken eklenecek.

******************************************************/
#define ETH_MAC_BASE_ADDR (0x40028000UL)
#define ETH_MMC_BASE_ADDR (0x40028100UL)
#define ETH_PTP_BASE_ADDR (0x40028700UL)
#define ETH_DMA_BASE_ADDR (0x40029000UL)
