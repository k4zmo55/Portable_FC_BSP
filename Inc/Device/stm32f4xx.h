...
/*
*   @brief Proje genelinde kullanılacak olan geri dönüş durumları 
*
*/
typedef enum{
    STATUS_OK               = 0x00,
...
/**************************************************
*     Bit Definations Macros for SPI Peripherals
**************************************************/

/* @SPI_CR1 Bir Positions Definitions */
...
/* @SPI_CR2 Bit Positions Definations */
...
/* @SPI_SR Bit Positions Definations */
